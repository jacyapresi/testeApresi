...
$cNF = '00000023'; //numero aleatório da NF
...
$nfe->tagCEST(1, '7000123');
$nfe->tagCEST(2, '7000123');
...
//Impostos
$nItem = 1; //produtos 1
$vTotTrib = '0'; // 226.80 ICMS + 51.50 ICMSST + 50.40 IPI + 39.36 PIS + 81.84 CONFIS
$resp = $nfe->tagimposto($nItem, $vTotTrib);
$nItem = 2; //produtos 2
$vTotTrib = '0'; // 61.20 ICMS + 2.34 PIS + 10.80 CONFIS
$resp = $nfe->tagimposto($nItem, $vTotTrib);
...
$pRedBC = '';
$vBC = '0'; // = $qTrib * $vUnTrib
$pICMS = '0'; // Alíquota Interna do Estado de GO 
$vICMS = '0'; // = $vBC * ( $pICMS / 100 )
$vICMSDeson = '';
$motDesICMS = '';
$modBCST = '';
...
$pMVAST = '';
$pRedBCST = '';
$vBCST = '0'; // Pauta do Chope Claro 1000ml em GO R$ 8,59 x 60 Litros
$pICMSST = '0'; // GO para GO
$vICMSST = '0'; // = (Valor da Pauta * Alíquota ICMS ST) - Valor ICMS Próprio
$pDif = '';
$vICMSDif = '';
$vICMSOp = '';
$vBCSTRet = '';
...
if ($resp) {
    ...
    $filename = "C:/xampp/htdocs/nfephp/vendor/nfe/homologacao/entradas/{$chave}-nfe.xml"; // Ambiente Windows
